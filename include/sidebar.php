  ...
  <div class="deznav">
  	<div class="deznav-scroll">
  		<ul class="metismenu" id="menu">
  			<li class="menu-title">Sri Arogya Hotel</li>
  			...
  			<li><a href="ecom-product-grid.php" class="" aria-expanded="false">
  					<div class="menu-icon">
  						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  							<path opacity="0.4" d="M16.191 2H7.81C4.77 2 3 3.78 3 6.83V17.16C3 20.26 4.77 22 7.81 22H16.191C19.28 22 21 20.26 21 17.16V6.83C21 3.78 19.28 2 16.191 2Z" fill="var(--primary)"></path>
  							<path fill-rule="evenodd" clip-rule="evenodd" d="M8.07996 6.65V6.66C7.64896 6.66 7.29996 7.01 7.29996 7.44C7.29996 7.87 7.64896 8.22 8.07996 8.22H11.069C11.5 8.22 11.85 7.87 11.85 7.429C11.85 7 11.5 6.65 11.069 6.65H8.07996ZM15.92 12.74H8.07996C7.64896 12.74 7.29996 12.39 7.29996 11.96C7.29996 11.53 7.64896 11.179 8.07996 11.179H15.92C16.35 11.179 16.7 11.53 16.7 11.96C16.7 12.39 16.35 12.74 15.92 12.74ZM15.92 17.31H8.07996C7.77996 17.35 7.48996 17.2 7.32996 16.95C7.16996 16.69 7.16996 16.36 7.32996 16.11C7.48996 15.85 7.77996 15.71 8.07996 15.74H15.92C16.319 15.78 16.62 16.12 16.62 16.53C16.62 16.929 16.319 17.27 15.92 17.31Z" fill="var(--primary)"></path>
  						</svg>
  					</div>
  			...
  			<li><a href="order-list.php" class="" aria-expanded="false">
  					<div class="menu-icon">
  						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  							<g opacity="0.5">
  			...
  			<li><a href="order-details.php" class="" aria-expanded="false">
  					<div class="menu-icon">
  						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  							<g opacity="0.5">
  					...
  					<span class="nav-text">Orders Details</span>
  				</a>
  			</li>
  			<li><a href="delivery_parterns.php" class="" aria-expanded="false">
  					<div class="menu-icon">
  						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  			...
  			<li><a href="kot.php" class="" aria-expanded="false">
  					<div class="menu-icon">
  						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  							<g opacity="0.5">
  								<path opacity="0.4" d="M16.0755 2H19.4615C20.8637 2 22 3.14585 22 4.55996V7.97452C22 9.38864 20.8637 10.5345 19.4615 10.5345H16.0755C14.6732 10.5345 13.537 9.38864 13.537 7.97452V4.55996C13.537 3.14585 14.6732 2 16.0755 2Z" fill="#90959F" />
  			...
  			<li><a href="whatsapp_integration.php" class="" aria-expanded="false">
  					<div class="menu-icon">
  						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  							<g opacity="0.5">
  					...
  					<span class="nav-text">Whats App Integration</span>
  				</a>
  			</li>
  			<li><a href="ecom-invoice.php" class="" aria-expanded="false">
  					<div class="menu-icon">
  						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  							<path opacity="0.4" d="M16.6756 2H7.33333C3.92889 2 2 3.92889 2 7.33333V16.6667C2 20.0711 3.92889 22 7.33333 22H16.6756C20.08 22 22 20.0711 22 16.6667V7.33333C22 3.92889 20.08 2 16.6756 2Z" fill="var(--primary)"></path>
  							<path d="M7.36866 9.36898C6.91533 9.36898 6.54199 9.74231 6.54199 10.2045V17.0756C6.54199 17.529 6.91533 17.9023 7.36866 17.9023C7.83088 17.9023 8.20421 17.529 8.20421 17.0756V10.2045C8.20421 9.74231 7.83088 9.36898 7.36866 9.36898Z" fill="var(--primary)"></path>
  							<path d="M12.0354 6.08897C11.5821 6.08897 11.2087 6.46231 11.2087 6.92453V17.0756C11.2087 17.529 11.5821 17.9023 12.0354 17.9023C12.4976 17.9023 12.871 17.529 12.871 17.0756V6.92453C12.871 6.46231 12.4976 6.08897 12.0354 6.08897Z" fill="var(--primary)"></path>
  							<path d="M16.64 12.9956C16.1778 12.9956 15.8044 13.369 15.8044 13.8312V17.0756C15.8044 17.529 16.1778 17.9023 16.6311 17.9023C17.0933 17.9023 17.4667 17.529 17.4667 17.0756V13.8312C17.4667 13.369 17.0933 12.9956 16.64 12.9956Z" fill="var(--primary)"></path>
  						</svg>
  					</div>
  					<span class="nav-text">Invoice</span>
  				</a>
  			</li>
  			<li><a href="ecom-checkout.php" class="" aria-expanded="false">
  					<div class="menu-icon">
  						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  							<path opacity="0.4" d="M13.7505 9.70301V7.68317C13.354 7.68317 13.0251 7.36375 13.0251 6.97857V4.57354C13.0251 4.25318 12.764 4.00047 12.4352 4.00047H5.7911C3.70213 4.00047 2 5.65299 2 7.68317V10.1154C2 10.3043 2.07737 10.4828 2.21277 10.6143C2.34816 10.7449 2.53191 10.82 2.72534 10.82C3.46035 10.82 4.02128 11.3273 4.02128 11.9944C4.02128 12.6905 3.45068 13.2448 2.73501 13.2532C2.33849 13.2532 2 13.5257 2 13.9203V16.3262C2 18.3555 3.70213 19.9995 5.78143 19.9995H12.4352C12.764 19.9995 13.0251 19.7449 13.0251 19.4265V17.3963C13.0251 17.0026 13.354 16.6917 13.7505 16.6917V14.8701C13.354 14.8701 13.0251 14.5497 13.0251 14.1655V10.4076C13.0251 10.0224 13.354 9.70301 13.7505 9.70301Z" fill="var(--primary)"></path>
  							<path d="M19.9787 11.9948C19.9787 12.69 20.559 13.2443 21.265 13.2537C21.6615 13.2537 22 13.5262 22 13.9113V16.3258C22 18.3559 20.3075 20 18.2186 20H15.0658C14.7466 20 14.4758 19.7454 14.4758 19.426V17.3967C14.4758 17.0022 14.1567 16.6921 13.7505 16.6921V14.8705C14.1567 14.8705 14.4758 14.5502 14.4758 14.1659V10.4081C14.4758 10.022 14.1567 9.70348 13.7505 9.70348V7.6827C14.1567 7.6827 14.4758 7.36328 14.4758 6.9781V4.57401C14.4758 4.25366 14.7466 4 15.0658 4H18.2186C20.3075 4 22 5.64406 22 7.6733V10.0407C22 10.2286 21.9226 10.4081 21.7872 10.5387C21.6518 10.6702 21.4681 10.7453 21.2747 10.7453C20.559 10.7453 19.9787 11.31 19.9787 11.9948Z" fill="var(--primary)"></path>
  						</svg>
  					</div>
  			...
  			<li><a href="setting.php" class="" aria-expanded="false">
  					<div class="menu-icon">
  						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  							<g opacity="0.5">
  								<path fill-rule="evenodd" clip-rule="evenodd" d="M15.2428 4.73756C15.2428 6.95855 17.0459 8.75902 19.2702 8.75902C19.5151 8.75782 19.7594 8.73431 20 8.68878V16.6615C20 20.0156 18.0215 22 14.6624 22H7.34636C3.97851 22 2 20.0156 2 16.6615V9.3561C2 6.00195 3.97851 4 7.34636 4H15.3131C15.2659 4.243 15.2423 4.49001 15.2428 4.73756ZM13.15 14.8966L16.0078 11.2088V11.1912C16.2525 10.8625 16.1901 10.3989 15.8671 10.1463C15.7108 10.0257 15.5122 9.97345 15.3167 10.0016C15.1211 10.0297 14.9453 10.1358 14.8295 10.2956L12.4201 13.3951L9.6766 11.2351C9.51997 11.1131 9.32071 11.0592 9.12381 11.0856C8.92691 11.1121 8.74898 11.2166 8.63019 11.3756L5.67562 15.1863C5.57177 15.3158 5.51586 15.4771 5.51734 15.6429C5.5002 15.9781 5.71187 16.2826 6.03238 16.3838C6.35288 16.485 6.70138 16.3573 6.88031 16.0732L9.35125 12.8771L12.0948 15.0283C12.2508 15.1541 12.4514 15.2111 12.6504 15.1863C12.8494 15.1615 13.0297 15.0569 13.15 14.8966Z" fill="#90959F" />
  			...
  			<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
  					...
  					<span class="nav-text">Login Details</span>
  				</a>
  				<ul aria-expanded="false">
  		...
  		<!-- <div class="plus-box">
				...
				<div class="copyright">
					<p class="fs-14"><strong>Arogya Admin</strong> © 2025 All Rights Reserved</p>
					<p class="fs-14">Made with <span class="heart"></span> by  Ultrakey IT Solutions Private Limited</p>
				</div> -->
  	</div>
  </div>
